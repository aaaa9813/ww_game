...
struct PT_DDZ_GAME_START_INFO {
	...
	PT_DDZ_GAME_START_INFO() :
			...
			id(PT_HOST_MESSAGE), nMsgid(PT_DDZ_GAME_START) {
	}
};
...
//=====ddz===
const int WAIT_DDZ_JIAOFEN_TIME = 3 * 1000;
const int WAIT_DDZ_DAPAI_TIME = 10 * 1000;

const int WAIT_DDZ_JIAOFEN_OFFLINE_TIME = 1 * 1000;
const int WAIT_DDZ_DAPAI_OFFLINE_TIME = 1 * 1000;
...
enum UserOnTimerID {
	...
	WAIT_DDZ_JIAOFEN,
	WAIT_DDZ_DAPAI,
	WAIT_DDZ_JIAOFEN_OFFLINE,
	WAIT_DDZ_DAPAI_OFFLINE,
