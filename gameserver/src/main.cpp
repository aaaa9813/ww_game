...
//	ww::ServerMsg info;
//	info.set_msg_type((ww::MSG_TYPE)1);
//
...
//
//
//	info.SerializeToArray(buffer, size);
//
////	char buf[1];
////	info.ParseFromArray(buf, 0);
//
//	ww::ServerMsg info1;
//	info1.ParseFromArray(buffer, size);
//
//	BaseHandler::Execute((ww::ServerMsg * )&info);
